"""Integration tests for GET /v1/impacts."""
...
def _m(**kw) -> FakeMetric:
    d = {"zone": "ES", "unit": "stress-l/kWh", "impact_type": "water",
         "scope": "operational", "valid": "true", "zone_status": "complete"}
    d.update(kw)
    return FakeMetric(_NOW, 1.5, d)
...
def test_returns_impact_structure(client, mock_db) -> None:
    """Valid metric produces a correctly nested Impact object.
