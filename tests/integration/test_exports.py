"""Integration tests for GET /v1/exports."""
...
def _m(**kw) -> FakeMetric:
    d = {"zone": "ES", "unit": "MW", "to": "FR", "data_state": "official",
         "datasource": "ENTSO-E", "valid": "true", "zone_status": "complete"}
    d.update(kw)
    return FakeMetric(_NOW, 500.0, d)
...
def test_returns_export_structure(client, mock_db) -> None:
    """Valid metric produces a correctly nested Export object.
    ...
    assert body[0]["series"][0]["exports"][0]["destination"] == "FR"
