"""Integration tests for GET /v1/imports."""
...
def _m(**kw) -> FakeMetric:
    d = {"zone": "ES", "unit": "MW", "from": "FR", "data_state": "official",
         "datasource": "ENTSO-E", "valid": "true", "zone_status": "complete"}
    d.update(kw)
    return FakeMetric(_NOW, 300.0, d)
...
def test_returns_import_structure(client, mock_db) -> None:
    """Valid metric produces a correctly nested Import object.
    ...
    assert body[0]["series"][0]["imports"][0]["source"] == "FR"
