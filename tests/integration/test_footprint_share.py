"""Integration tests for GET /v1/footprint_share."""
...
_URL = "/v1/footprint-share"


def _m(**kw) -> FakeMetric:
    d = {"zone": "ES", "unit": "gCO2/kWh", "footprint_type": "carbon",
         "scope": "life-cycle", "source": "FR", "valid": "true", "zone_status": "complete"}
    d.update(kw)
    return FakeMetric(_NOW, 180.0, d)
...
def test_returns_footprint_share_structure(client, mock_db) -> None:
    """Valid metric produces a correctly nested FootprintShare object.
